...
class CreditorDataException extends Failure {
  const CreditorDataException({required this.code});
...
class LoanDataException extends Failure {
  const LoanDataException({required this.code});
...
class TransactionDataException extends Failure {
  const TransactionDataException({required this.code});
