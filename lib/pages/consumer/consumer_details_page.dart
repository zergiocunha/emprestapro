...
import 'package:emprestapro/pages/consumer/widgets/consumer_info_container.dart';
        ...
        children: [
          Positioned.fill(
            child: ListView.separated(
              padding: const EdgeInsets.only(top: 370, bottom: 10),
